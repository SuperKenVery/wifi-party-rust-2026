// Generated from ONNX "../assets/all_rt.onnx" by burn-onnx
use burn::prelude::*;
    ...
    pub fn new(device: &B::Device) -> Self {
        ...
        let constant47: burn::module::Param<Tensor<B, 3>> = burn::module::Param::uninitialized(
            ...
            move |device, _require_grad| Tensor::<
                B,
                3,
            >::zeros([16, 1, 1], (device, burn::tensor::DType::F32)),
            device.clone(),
            false,
            [16, 1, 1].into(),
        );
    ...
    pub fn new(device: &B::Device) -> Self {
        ...
        let constant65: burn::module::Param<Tensor<B, 3>> = burn::module::Param::uninitialized(
            ...
            move |device, _require_grad| Tensor::<
                B,
                3,
            >::zeros([32, 1, 1], (device, burn::tensor::DType::F32)),
            device.clone(),
            false,
            [32, 1, 1].into(),
        );
    ...
    pub fn new(device: &B::Device) -> Self {
        ...
        let constant83: burn::module::Param<Tensor<B, 2>> = burn::module::Param::uninitialized(
            ...
            move |device, _require_grad| Tensor::<
                B,
                2,
            >::zeros([16, 1], (device, burn::tensor::DType::F32)),
            device.clone(),
            false,
            [16, 1].into(),
        );
        ...
        let constant240: burn::module::Param<Tensor<B, 3>> = burn::module::Param::uninitialized(
            ...
            move |device, _require_grad| Tensor::<
                B,
                3,
            >::zeros([1, 768, 32], (device, burn::tensor::DType::F32)),
            device.clone(),
            false,
            [1, 768, 32].into(),
        );
        ...
        let constant252: burn::module::Param<Tensor<B, 3>> = burn::module::Param::uninitialized(
            ...
            move |device, _require_grad| Tensor::<
                B,
                3,
            >::zeros([1, 128, 32], (device, burn::tensor::DType::F32)),
            device.clone(),
            false,
            [1, 128, 32].into(),
        );
        ...
        let constant121: burn::module::Param<Tensor<B, 3>> = burn::module::Param::uninitialized(
            ...
            move |device, _require_grad| Tensor::<
                B,
                3,
            >::zeros([64, 1, 1], (device, burn::tensor::DType::F32)),
            device.clone(),
            false,
            [64, 1, 1].into(),
        );
...
impl<B: Backend> Default for Model<B> {
    fn default() -> Self {
        Self::from_file("src/model/all_rt.bpk", &Default::default())
    }
}
