...
impl<const CHANNELS: usize, const SAMPLE_RATE: u32, A, B, Next> PushNode<CHANNELS, SAMPLE_RATE, Next>
    for TeeNode<A, B>
where
    A: PushNode<CHANNELS, SAMPLE_RATE, ()>,
    B: PushNode<CHANNELS, SAMPLE_RATE, ()>,
{
